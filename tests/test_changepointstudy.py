...
class TestTwoParameterModel:
    def test_fit_1cp_1bp_2hp(self):
        ...
        np.testing.assert_almost_equal(S.log_evidence, -15.072007461556161, decimal=5,
        ...
        d, p = S.get_duration_distribution(['ChangePoint', 'BreakPoint'])
    ...
    def test_fit_hyperpriors(self):
        ...
        # test model evidence value
        np.testing.assert_almost_equal(S.log_evidence, -15.709534690217343, decimal=5,
                                       err_msg='Erroneous log-evidence value.')
