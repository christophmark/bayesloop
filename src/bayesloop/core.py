...
class HyperStudy(Study):
    ...
    def fit(self, forward_only=False, evidence_only=False, silent=False, n_jobs=1, custom_hyper_grid=False,
        ...
        Args:
            ...
            n_jobs(int): Number of processes to employ. Multiprocessing is based on the 'pathos' module.
        ...
        if len(self.hyper_grid_values) > 1:
            ...
            if n_jobs > 1:
                ...
                # hyper-grid values
                sub_studies = pool.map(self._parallel_fit,
                                      range(n_jobs),
                                      [n_jobs]*n_jobs,
                                      [forward_only]*n_jobs,
                                      [evidence_only]*n_jobs,
                                      [silent]*n_jobs,
                                      [cache_likelihoods]*n_jobs,
                                      [max_cache_size]*n_jobs)
